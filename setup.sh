#!/bin/bash
# ============================================
# GitLab CE Auto Setup Script (One-Click Start)
# ============================================
...
if [ ! -f .env ]; then
    ...
    if [ -f .env.example ]; then
        ...
        log_info "Setelah selesai, jalankan: ./setup.sh"
        exit 0
    else
...
echo ""
echo "Script lain yang tersedia:"
echo "  ./scripts/manage.sh status   - Cek status"
echo "  ./scripts/manage.sh logs     - Lihat log"
echo "  ./scripts/manage.sh fix      - Fix socket"
echo "  ./scripts/manage.sh backup   - Buat backup"
echo ""
echo "============================================"
echo ""
